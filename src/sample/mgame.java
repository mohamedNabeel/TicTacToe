...
public class mgame {
        ...
        static Label computer = new Label("", new ImageView(new Image("redUser.png")));
        ...
        public static Pane MultiScene(){
            ...
            Player1.setText(Multi.MPlayer_One.getText());
            ...
            computer.setText(Multi.MPlayer_two.getText());
        ...
        public static void Mstart(){
            ...
            if(b00.equals(b01) && b00.equals(b02) && !b00.equals("")){
                ...
                if(!firstPlayerTurn){
                    ...
                    c_score.setText(Integer.valueOf(c_score.getText()) + 1 + "");
                    Winner.setText(computer.getText() + " won");
        ...
        public static void actionPerformed(ActionEvent e){
            ...
            if(!isGameEnd && item.getText().equals("")) {
              if(firstPlayerTurn) {
                  ...
                  item.setText("O");
                  item.setStyle("-fx-text-fill: #ce5122;-fx-font-size: 70");
                  symbol.setText("X");
              }
